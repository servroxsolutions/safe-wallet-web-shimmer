...
import type GnosisSafeProxyFactoryEthersContract from '@servrox/safe-ethers-lib-shimmer/dist/src/contracts/GnosisSafeProxyFactory/GnosisSafeProxyFactoryEthersContract'
